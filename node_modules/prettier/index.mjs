...
var { parsers, printers } = createParsersAndPrinters([
  {
    importPlugin: () => import("prettier/plugins/acorn.mjs"),
    parsers: ["acorn", "espree"]
  },
  {
    importPlugin: () => import("prettier/plugins/angular.mjs"),
    parsers: [
      "__ng_action",
      "__ng_binding",
      "__ng_interpolation",
  ...
  {
    importPlugin: () => import("prettier/plugins/babel.mjs"),
    parsers: [
      "babel",
      "babel-flow",
      "babel-ts",
  ...
  {
    importPlugin: () => import("prettier/plugins/estree.mjs"),
    printers: ["estree", "estree-json"]
  },
  {
    importPlugin: () => import("prettier/plugins/flow.mjs"),
    parsers: ["flow"]
  },
  {
    importPlugin: () => import("prettier/plugins/glimmer.mjs"),
    parsers: ["glimmer"],
    printers: ["glimmer"]
  },
  {
    importPlugin: () => import("prettier/plugins/graphql.mjs"),
    parsers: ["graphql"],
    printers: ["graphql"]
  },
  {
    importPlugin: () => import("prettier/plugins/html.mjs"),
    parsers: ["html", "angular", "vue", "lwc"],
    printers: ["html"]
  },
  {
    importPlugin: () => import("prettier/plugins/markdown.mjs"),
    parsers: ["markdown", "mdx", "remark"],
    printers: ["mdast"]
  },
  {
    importPlugin: () => import("prettier/plugins/meriyah.mjs"),
    parsers: ["meriyah"]
  },
  {
    importPlugin: () => import("prettier/plugins/postcss.mjs"),
    parsers: ["css", "less", "scss"],
    printers: ["postcss"]
  },
  {
    importPlugin: () => import("prettier/plugins/typescript.mjs"),
    parsers: ["typescript"]
  },
  {
    importPlugin: () => import("prettier/plugins/yaml.mjs"),
    parsers: ["yaml"],
    printers: ["yaml"]
  }
]);
